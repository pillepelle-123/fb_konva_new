...
export function ToolSettingsContainer({ isExpanded, isVisible, children }: ToolSettingsContainerProps) {
  return (
    <Card className={`h-full rounded-none border-l-0 border-t-0 border-b-0 shadow-lg transition-all duration-200 flex flex-col overflow-y-auto scrollbar-hide ${
