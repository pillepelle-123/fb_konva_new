  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Hi ${inviteeName},</p>
        <p><strong>${inviterName}</strong> has invited you to collaborate on the book "<strong>${bookName}</strong>" on dein-freundebuch.de.</p>
        ...
        <p>Best regards,<br>The dein-freundebuch.de team</p>
      </div>
    `
  };
